...
const enableManusRuntime = process.env.VITE_MANUS_RUNTIME === "true";
const enableManusDebug = process.env.VITE_MANUS_DEBUG === "true";
...
const plugins = [
  ...
  ...(enableManusDebug ? [vitePluginManusDebugCollector()] : []),
  {
    name: "optional-umami-analytics",
